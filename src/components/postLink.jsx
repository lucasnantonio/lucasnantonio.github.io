	...
	return (
      ...
      ${post.frontmatter.size !== 'large' ? 'w-100' : 'w-100'}
		...
		>
			...
			<div style={{ minHeight: '11rem' }} className="black pb4 mt2 flex justify-between">
				<div className="w-100">
					<div className="flex justify-between items-center">
						<p
							className={`neue-regular f3-l f4 measure-narrow mt3 mb2 fw5 tracked-tight ${isHovered
								? 'u underline'
								: ''}`}
						>
					...
					<p className={'f3 fw5 tracked-tight black-40 neue-regular lh-copy pv0 mb0 mt0 w-100'}>
						{post.frontmatter.subtitle}
					</p>
					<div style={{ marginLeft: '-.2rem' }} className="mono mt3 pt1 flex tr items-start">
						{/* {topicTags} */}
					</div>
				</div>
			</div>
